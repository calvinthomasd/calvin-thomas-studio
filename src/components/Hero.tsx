    ...
    <section className={styles.hero}>
      ...
      <div className={styles.photoStrip}>
        ...
        <div className={styles.photo}>
          ...
          <Image src="/landing-images/toronto-musician-headshot-studio-portrait.jpg" alt="Toronto musician studio headshot of a woman with short blonde natural hair, wearing a bold green chunky knit cardigan and a delicate gold necklace, arms folded with a calm, self-assured gaze against a textured grey-green background" fill sizes="(max-width: 1024px) 50vw, 18vw" className={`${styles.photoImage} ${styles.crossfadeD}`} priority />
        </div>
        <div className={styles.photo}>
          ...
          <Image src="/landing-images/performing-artist-headshot-toronto-studio.jpg" alt="Toronto performing artist headshot of a young woman with long dark wavy hair, wearing a terracotta button-up shirt over a white top, beaming with a wide natural smile against a soft warm grey studio background" fill sizes="(max-width: 1024px) 50vw, 18vw" className={`${styles.photoImage} ${styles.crossfadeC}`} priority />
        </div>
      </div>
